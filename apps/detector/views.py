...
import torch
import torchvision
import uuid # uuidをimportする
from pathlib import Path # Pathをimportする
from apps.app import db
from apps.crud.models import User
from apps.detector.models import UserImage, UserImageTag
from flask import Blueprint, render_template, current_app, send_from_directory
from apps.detector.forms import UploadImageForm, DetectorForm, DeleteFrom
from flask import (
    Blueprint,
    current_app,
    render_template,
...
@dt.route("/")
def index():
    # UserとUserImageをs１Joinsいて画像一覧を取得する
    user_images = (
...
def save_detected_image_tags(user_image, tags, detected_image_filen_name):
    # 検知後画像の保存先パスをDBに保存する
    user_image.image_path = detected_image_filen_name
    # 検知フラグをTrueにする
